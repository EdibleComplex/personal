...
location = 1 #engine -> perform_action
ccdetail = 0
lwadetail = 0
bdetail = 0
...
class Engine(object):
    ...
    def get_user_command(self):
        ...
        if command1 in commands:
            verb = command1
            command2 = raw_input("What will you %s with?" % verb)
...
class Central_Corridor(Scene):
    ...
    def __init__(self):
        ...
        location = 1
	global enviroment
        enviroment = ['armory', 'bridge', 'pod']
        self.describe(ccdetail, location)
